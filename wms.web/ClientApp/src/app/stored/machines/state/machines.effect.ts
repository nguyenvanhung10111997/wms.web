...
export class MachinesEffect {
  constructor(
    ...
    private _service: MachinesService
  ) {}

  //#region GET_ALL
  getAll$ = createEffect(() =>
    this.actions$.pipe(
      ofType(actions.MACHINES_ACTIONS.GET_ALL),
  ...
  create$ = createEffect(() =>
    this.actions$.pipe(
      ofType(actions.MACHINES_ACTIONS.CREATE),
  ...
  update$ = createEffect(() =>
    this.actions$.pipe(
      ofType(actions.MACHINES_ACTIONS.UPDATE),
  ...
  delete$ = createEffect(() =>
    this.actions$.pipe(
      ofType(actions.MACHINES_ACTIONS.DELETE),
