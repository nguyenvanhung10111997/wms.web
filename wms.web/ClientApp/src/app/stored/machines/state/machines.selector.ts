...
import {
  IMachinesState as IState,
  getMachinesState as State
} from "./machines.state";

//#region GET_ALL
export const getAllSuccess = createSelector(State, (state: IState) => {
  if (
    state.action === actions.MACHINES_ACTIONS.GET_ALL &&
    state.done &&
    !state.error
  ) {
    return state.data;
...
export const getAllError = createSelector(State, (state: IState) => {
  return state.action === actions.MACHINES_ACTIONS.GET_ALL ? state.error : null;
});
//#endregion GET_ALL
...
export const createSuccess = createSelector(State, (state: IState) => {
  if (
    state.action === actions.MACHINES_ACTIONS.CREATE &&
    state.done &&
    !state.error
  ) {
    return state.data;
...
export const createError = createSelector(State, (state: IState) => {
  return state.action === actions.MACHINES_ACTIONS.CREATE ? state.error : null;
});
//#endregion CREATE
...
export const updateSuccess = createSelector(State, (state: IState) => {
  if (
    state.action === actions.MACHINES_ACTIONS.UPDATE &&
    state.done &&
    !state.error
  ) {
    return state.data;
...
export const updateError = createSelector(State, (state: IState) => {
  return state.action === actions.MACHINES_ACTIONS.UPDATE ? state.error : null;
});
//#endregion UPDATE
...
export const deleteSuccess = createSelector(State, (state: IState) => {
  if (
    state.action === actions.MACHINES_ACTIONS.DELETE &&
    state.done &&
    !state.error
  ) {
    return state.data;
...
export const deleteError = createSelector(State, (state: IState) => {
  return state.action === actions.MACHINES_ACTIONS.DELETE ? state.error : null;
});
//#endregion DELETE
